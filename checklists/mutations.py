...
class SubmitHabitCheckList(graphene.Mutation):
    class Arguments:
        ...
        meal_with_water = graphene.String(required=True)
        meal_with_snack = graphene.String(required=True)
        meal_with_night_food = graphene.String(required=True)
        ...
        saying_repeat = graphene.String(required=True)
        ...
        good_thing = graphene.String(required=True)
        bad_thing = graphene.String(required=True)
...
class SubmitCheckList(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        if is_previous_answer:
            ...
            return types.SubmitCheckListResponse(checkListAnswers=checkListAnswers)
